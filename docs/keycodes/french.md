...
| Key | Code | Alias | Adjusted |
| --- | --- | --- | --: |
| Pow2 | 0x0035 | `pow2`, `²` | <span style="color:var(--vp-code-color)">✔</span> |
| Amprsand | 0x001E | `amprsand` | <span style="color:var(--vp-code-color)">✔</span> |
| Eacu | 0x001F | `eacu`, `É` | <span style="color:var(--vp-code-color)">✔</span> |
| DoubleQuote | 0x0020 | `doublequote` | <span style="color:var(--vp-code-color)">✔</span> |
| Quote | 0x0021 | `quote` | <span style="color:var(--vp-code-color)">✔</span> |
| LeftParenthesis | 0x0022 | `leftparenthesis` | <span style="color:var(--vp-code-color)">✔</span> |
| Minus | 0x0023 | `minus` | <span style="color:var(--vp-code-color)">✔</span> |
| Egrv | 0x0024 | `egrv`, `È` | <span style="color:var(--vp-code-color)">✔</span> |
| Underscore | 0x0025 | `underscore` | <span style="color:var(--vp-code-color)">✔</span> |
| Cced | 0x0026 | `cced`, `Ç` | <span style="color:var(--vp-code-color)">✔</span> |
| Agrv | 0x0027 | `agrv`, `À` | <span style="color:var(--vp-code-color)">✔</span> |
| RightParenthesis | 0x002D | `rightparenthesis` | <span style="color:var(--vp-code-color)">✔</span> |
| A | 0x0014 | `a` | <span style="color:var(--vp-code-color)">✔</span> |
| Z | 0x001A | `z` | <span style="color:var(--vp-code-color)">✔</span> |
| Circumflex | 0x002F | `circumflex` | <span style="color:var(--vp-code-color)">✔</span> |
| Dollar | 0x0030 | `dollar` | <span style="color:var(--vp-code-color)">✔</span> |
| Q | 0x0004 | `q` | <span style="color:var(--vp-code-color)">✔</span> |
